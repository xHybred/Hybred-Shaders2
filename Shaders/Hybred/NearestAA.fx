/*
 ...
 Modified & Optimized for ReShade by JPulowski. Modified further for AA benefits by Hybred
...
uniform float NoiseLevel < __UNIFORM_SLIDER_FLOAT1
	...
	ui_step = 0.005;
	ui_tooltip = "Level of noise in the image.";
> = 0.15;
...
uniform float GaussianSigma < __UNIFORM_SLIDER_FLOAT1
	ui_min = 1.0; ui_max = 60.0;
	ui_label = "Blur Strength";
	ui_step = 0.0500;
	ui_tooltip = "Controls the amount of gaussian blur.";
> = 35.0;
