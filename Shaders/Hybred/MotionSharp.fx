...
// 4 = High
// Default is off.
#define M_Quality 4 //Manualy set shader Quality. Defaults to 2 when set to off.
...
#define B_Accuracy 1 //Bilateral Accuracy

//Use this to enable motion Sharpen option also reduces perf a bit more
#define Motion_Sharpen 1

#define SRGB 0

// It is best to run Motion Sharp after tonemapping.
...
uniform int Debug_View <
	...
	ui_label = "Debug View";
	ui_tooltip = "This is to DeBug Motion Sharp and lets you fine tune the shader.\n"
				 "Let me have fun with names and tooltips.......";
	ui_category = "Debug";
> = 0;
...
uniform int F_DeNoise <
	...
	ui_tooltip = "This Denoiser can help with Noise in the image.\n"
				 "LvL One DeNoiser Works with Motion Sharp Only.\n"
