 ...
 //*
 //* Have fun
 //* Additional Credits: Jose Negrete (AKA BlueSkyDefender) & Hybred
 //*
...
uniform float Text_Preservation <
 	...
 	ui_tooltip = "Adjust to avoid the AA touching text.";
	ui_step = 0.005;
...
uniform int View_Mode <
	ui_type = "combo";
	ui_items = "Off\0On\0";
	ui_label = "UI/Text Mask";
 	ui_tooltip = "On adds a mask that tries to avoid text UI elements.";
	ui_category = "LDAA";
> = 1;
